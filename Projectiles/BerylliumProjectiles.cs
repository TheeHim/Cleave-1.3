...
namespace Cleave.Projectiles.Images
{
    public class Beryllium_Bronze_Dagger : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            if (projectile.owner == Main.myPlayer)
            {
                for (int i = 0; i < 10; i++)
                {
                    Dust.NewDustDirect(projectile.Center, projectile.width = 10, projectile.height = 10, 218);
                }
            }
        }
    }
	 ...
	 */
    public class BBGrip : ModProjectile
    {
        public override void SetStaticDefaults()
        {
        ...
        public override void AI()
        {
            ...
            {
                player.ClearBuff(ModContent.BuffType<Buffs.Images.BBGrip>());
            }
            if (player.HasBuff(ModContent.BuffType<Buffs.Images.BBGrip>()))
            {
            ...
            idlePosition.Y -= 38f; // Go up 48 coordinates (three tiles from the center of the player)
